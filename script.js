...
const stations = [
    ...
    { file: "03_Initial_Flight_Attendant.wav", title: "Initial Flight Attendant" },
    { file: "04_In-Flight_Request.wav", title: "In-Flight Request" },
    { file: "05_Passport_Control.wav", title: "Passport Control" },
    { file: "06_Customs_Clearance.wav", title: "Customs Clearance" },
    { file: "07_Finding_Transportation.wav", title: "Finding Transportation" },
    { file: "08_Hotel_Check-in.wav", title: "Hotel Check-in" },
    { file: "09_Room_Problem_Arises.wav", title: "Room Problem Arises" },
    { file: "10_Solving_the_Room_Problem.wav", title: "Solving the Problem" },
    { file: "11_Car_Rental.wav", title: "Car Rental" },
    { file: "12_Fancy_Dinner.wav", title: "Fancy Dinner" },
    { file: "13_Restaurant_Problem.wav", title: "Restaurant Problem" },
    { file: "14_Falling_Ill.wav", title: "Falling Ill" },
    { file: "15_Hospital_Visit.wav", title: "Hospital Visit" },
    { file: "16_Pharmacy_Run.wav", title: "Pharmacy Run" },
    { file: "17_Police_Station_Report.wav", title: "Police Station Report" },
    { file: "18_Shoe_Shopping.wav", title: "Shoe Shopping" },
    { file: "19_Returning_the_Car.wav", title: "Returning the Car" },
    { file: "20_Arranging_Airport_Transfer.wav", title: "Arranging Transfer" },
    { file: "21_Taxi_to_the_Airport.wav", title: "Taxi to Airport" }
];
...
document.getElementById('btn-game').onclick = () => alert("Match Game Coming Soon!");
